...
var _KInputModule = _interopRequireDefault(require("./KInput.module.css"));
var _lib = require("../../lib");
var _KChecklist = _interopRequireDefault(require("./KChecklist"));
...
const KInput = props => {
  ...
  const classFocus = InputIsFocussed ? _KInputModule.default["input_focused"] : "";
  const classContent = [_KInputModule.default.KInput, _KInputModule.default["KInput_" + pers], _KInputModule.default["cont_" + props.type]];
  const classLabel = [_KInputModule.default.KInput_label, classFocus, props.className];
  const classDivInput = [_KInputModule.default.KInput_input, classFocus, _KInputModule.default["validate_" + InputIsValid]];
  const classDivCheckList = [_KInputModule.default.KInput_checklist, classFocus, _KInputModule.default["validate_" + InputIsValid]];
  if (props.list) {
    sTipo = "list";
  }
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: _KInputModule.default.errorText
  ...
  }, /*#__PURE__*/_react.default.createElement(_KChecklist.default, {
    list: effList,
    id: props.id,
    pidobj: props.pidobj
